 ...
 *
 *      ScreenShotListenUtils manager = ScreenShotListenUtils.newInstance(context);
 *
 *      manager.setListener(
 ...
 *
 */
public class ScreenShotListenUtils {
        private static final String TAG = "ScreenShotListenUtils";
        ...
        private ScreenShotListenUtils(Context context) {
            if (context == null) {
        ...
        public static ScreenShotListenUtils newInstance(Context context) {
            assertInMainThread();
            return new ScreenShotListenUtils(context);
        }
